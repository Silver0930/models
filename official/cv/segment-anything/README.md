...
|python|             Mindspore                   |                                                         CANN                                                 |                 Mindformers                    |
|:----:|:---------------------------------------:|:------------------------------------------------------------------------------------------------------------:|:----------------------------------------------:|
|\>=3.8|[2.3.1](https://www.mindspore.cn/install)|[8.0.RC2.beta1](https://www.hiascend.com/developer/download/community/result?module=cann&cann=8.0.RC2.2.beta1)|[1.0.0](https://gitee.com/mindspore/mindformers)|
